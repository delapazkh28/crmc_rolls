                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="d-flex flex-column flex-sm-row">
                                            ...
                                            <div class="flex" style="min-width: 200px;">
                                                <div class="d-flex">
                                                    <div>
                                                        <h4 class="card-title mb-1"><a href="teacher-subject">IT 1101 - Learn Vue.js</a></h4>
                                                ...
                                                <div class="d-flex align-items-end">
                                                    <div class="d-flex flex flex-column mr-3">
                                                        <div class="d-flex align-items-center py-2 border-bottom">
                                                            <span class="mr-2">GROUP 2</span>
                                                            <small class="text-muted ml-auto">30 Enrolled</small>
                                                        </div>
                                                        <div class="d-flex align-items-center py-2">
                                                            <span class="mr-2">1st Semester 2021-2022</span>
                                                            <small class="badge badge-vuejs ml-auto">Published</small>
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="d-flex flex-column flex-sm-row">
                                            ...
                                            <div class="flex" style="min-width: 200px;">
                                                <div class="d-flex">
                                                    <div>
                                                        <h4 class="card-title mb-1"><a href="instructor-course-edit.html">IT 1202 - Npm &amp; Gulp Advanced Workflow</a></h4>
                                                ...
                                                <div class="d-flex align-items-end">
                                                    <div class="d-flex flex flex-column mr-3">
                                                        <div class="d-flex align-items-center py-2 border-bottom">
                                                        <span class="mr-2">GROUP 3</span>
                                                            <small class="text-muted ml-auto">24 Enrolled</small>
                                                        </div>
                                                        <div class="d-flex align-items-center py-2">
                                                            <span class="mr-2">1st Semester 2021-2022</span>
                                                            <small class="badge badge-vuejs ml-auto">Published</small>
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="d-flex flex-column flex-sm-row">
                                            ...
                                            <div class="flex" style="min-width: 200px;">
                                                <div class="d-flex">
                                                    <div>
                                                        <h4 class="card-title mb-1"><a href="instructor-course-edit.html">IT 2201 - Gitlab for Beginners</a></h4>
                                                ...
                                                <div class="d-flex align-items-end">
                                                    <div class="d-flex flex flex-column mr-3">
                                                        <div class="d-flex align-items-center py-2 border-bottom">
                                                            <span class="mr-2">GROUP 1</span>
                                                            <small class="text-muted ml-auto">30 Enrolled</small>
                                                        </div>
                                                        <div class="d-flex align-items-center py-2">
                                                          <span class="mr-2">1st Semester 2021-2022</span>
                                                          <span class="badge badge-angular ml-auto">Unpublished</small>
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="d-flex flex-column flex-sm-row">
                                            ...
                                            <div class="flex" style="min-width: 200px;">
                                                <div class="d-flex">
                                                    <div>
                                                        <h4 class="card-title mb-1"><a href="instructor-course-edit.html">IT 3030 -Ruby on Rails Workflows</a></h4>
                                                        <p class="text-muted">Let’s start with a quick tour of Vue’s data binding features.</p>
                                                    </div>
                                                    <div class="dropdown ml-auto">
                                                        <a href="#" class="dropdown-toggle text-muted" data-caret="false" data-toggle="dropdown">
                                                ...
                                                <div class="d-flex align-items-end">
                                                    <div class="d-flex flex flex-column mr-3">
                                                        <div class="d-flex align-items-center py-2 border-bottom">
                                                        <span class="mr-2">GROUP 8</span>
                                                            <small class="text-muted ml-auto">12 Enrolled</small>
                                                        </div>
                                                        <div class="d-flex align-items-center py-2">
                                                            <span class="mr-2">1st Semester 2021-2022</span>
                                                            <small class="badge badge-vuejs ml-auto">Published</small>
