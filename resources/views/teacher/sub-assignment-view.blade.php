        ...
        <div class="mdk-drawer-layout js-mdk-drawer-layout" data-push data-responsive-width="992px">
                ...
                <div class="container-fluid page__heading-container">
                        <div class="page__heading d-flex flex-column flex-md-row align-items-center justify-content-center justify-content-lg-between text-center text-lg-left">
                            <div>
                                <h1 class="m-lg-0">IT 1101 - Learn Vue JS > Assignment</h1>
                        ...
                        <div class="row">
                                ...
                                <div class="card">
                                    <div class="card-form__body card-body">
                                        ...
                                        <div class="form-group">
                                            <label for="fname"><h3>Assignment 1: Hello World Home Page</h3></label>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="card">
                                                <div class="card-body">
                                                Lorem ipsum dolor sit amet, consectetur adipiscing elit. Aliquam malesuada quis ex efficitur venenatis. Nulla tempus 
                                                nisi auctor, maximus libero quis, porta erat. Sed eu ipsum sit amet arcu tristique pellentesque. Pellentesque semper, 
                                                tortor id gravida semper, odio purus tempus lorem, vitae lacinia dolor eros ac ex. Sed rutrum sit amet ipsum in vestibulum. 
                                                Orci varius natoque penatibus et magnis dis parturient montes, nascetur ridiculus mus. Fusce efficitur massa sed rutrum 
                                                cursus. Pellentesque at molestie justo. Phasellus semper malesuada mauris, nec tincidunt nisl porttitor a. 
                                                Quisque in luctus purus, ac ultrices magna. Mauris venenatis dictum arcu non mollis. Fusce sollicitudin leo vel nulla 
                                                malesuada, a eleifend magna elementum. Sed sem dui, posuere sed est ut, hendrerit feugiat neque. Nullam nec magna sit amet 
                                                enim tempus tempus vitae ullamcorper lacus. Nullam tincidunt facilisis mi, ac pellentesque urna aliquam eu.
                                                </div>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            ...
                                            <label for="category">Submission Type</label><br />
                                            
                                            <span>Online</span>
                                            
                                        </div>
                                        <div class="form-group">
                                            <label for="category">Points</label><br />
                                            <span>100</span>
                                        </div>
                                        ...
                                        <div class="form-group">
                                             ...
                                             <!-- <div class="form-row">
                                                <div class="col-12 col-md-6 mb-3">
                                                    <label for="validationSample01">Available from</label>
                                                    <span>January 28, 2022</span>
                                                </div>
                                                <div class="col-12 col-md-6 mb-3">
                                                    <label for="validationSample02">to</label>
                            ...
                            <div class="card">
                                    <div class="card-header card-header-large bg-light d-flex align-items-center">
                                        <div class="flex">
                                            <h4 class="card-header__title">Related Items</h4>
                                        </div>
                                    </div>
                                    ...
                                    <ul class="list-group list-group-fit">
                                        <li class="list-group-item">
                                            <div class="media">
                                                <div class="media-body">
                                                    <a href="teacher-subject">Speed Grader</a>
                                                </div>
                                        ...
                                        <li class="list-group-item">
                                            <div class="media">
                                                <div class="media-body">
                                                    <a href="sub-announcement">Download submissions</a>
                                                </div>
                                ...
                                <div class="card">
                                    ...
                                    <ul class="list-group list-group-fit">
                                        ...
                                        <li class="list-group-item">
                                            <div class="media">
                                                <div class="media-body">
                                                    <a href="subject-modules">Modules</a>
                                        ...
                                        <li class="list-group-item active">
                                            <div class="media">
                                                <div class="media-body">
                                                    <a class="text-white" href="sub-assignment">Assignments</a>
                                                </div>
