        ...
        <div class="mdk-drawer-layout js-mdk-drawer-layout" data-push data-responsive-width="992px">
                ...
                <div class="container-fluid page__heading-container">
                        <div class="page__heading d-flex flex-column flex-md-row align-items-center justify-content-center justify-content-lg-between text-center text-lg-left">
                            <div>
                                <h1 class="m-lg-0">IT 1101 - Learn Vue JS > Assignment > Create New</h1>
                                ...
                                <div class="card">
                                    <div class="card-form__body card-body">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select id="category" class="custom-select col-md-2">
                                                <option value="usa">Online</option>
                                                <option value="usa">On Paper</option>
                                                <option value="usa">No Submission</option>
                                            </select>
                                        </div>
                                        <div class="form-group">
                                            <label for="category">Points</label><br />
                                            <input id="fname" type="text" class="form-control col-md-2" placeholder="" value="">
                                        </div>

                                        <div class="form-group">
                                            <label for="category">Due Date</label><br />
                                            <input id="fname" type="date" class="form-control col-md-12" placeholder="" value="">
                                        </div>
                                        ...
                                        <div class="form-group">
                                             ...
                                             <div class="form-row">
                                                <div class="col-12 col-md-6 mb-3">
                                                    ...
                                                    <input type="date" class="form-control" id="validationSample01" placeholder="" value="Mark" required="">
                                                </div>
                                                <div class="col-12 col-md-6 mb-3">
                                                    <label for="validationSample02">Available until</label>
                                                    <input type="date" class="form-control" id="validationSample02" placeholder="" value="Otto" required="">
                                                </div>
                                            </div>
                                        </div>
