                    ...
                    <div class="container-fluid page__container">
                        <div class="row">
                            ...
                            <div class="card">
                                ...
                                <div class="card-header card-header-large bg-light d-flex align-items-center">
                                        <div class="flex">
                                            <h4 class="card-header__title"><a href="#"><div data-id="1" id="arrow1" class="fa fa-chevron-right rotate"></div></a> Course Description</h4>
                                        </div>
                                    </div>
                                    ...
                                    <ul class="list-group list-group-fit">
                                        <li class="list-group-item active">
                                            <div class="media">
                                                ...
                                                <div class="media-body">
                                                    <a class="text-white" href="teacher-subject">Home</a>
                                                </div>
