        ...
        <div class="mdk-drawer-layout js-mdk-drawer-layout" data-push data-responsive-width="992px">
                ...
                <div class="container-fluid page__heading-container">
                        <div class="page__heading d-flex flex-column flex-md-row align-items-center justify-content-center justify-content-lg-between text-center text-lg-left">
                            <div>
                                <h1 class="m-lg-0">Learn Vue JS > Announcements</h1>
                        ...
                        <div class="row">
                            ...
                            <div class="card">
                                    <div class="card-header card-header-large bg-light d-flex align-items-center">
                                        <div class="flex">
                                            <h4 class="card-header__title">Welcome Students!</h4>
                                        </div>
                                    </div>
                                    <div class="card-body">
                                ...
                                <div class="card">
                                    <div class="card-header card-header-large bg-light d-flex align-items-center">
                                        <div class="flex">
                                            <h4 class="card-header__title">No Class today</h4>
                                        </div>
                                    </div>
                                    <div class="card-body">
                                        <p>No classes today in observance of the Holiday</p>
                                    </div>
                                </div> 
                                    ...
                                    <ul class="list-group list-group-fit">
                                        ...
                                        <li class="list-group-item active">
                                            <div class="media">
                                                ...
                                                <div class="media-body">
                                                    <a class="text-white" href="sub-announcement">Announcements</a>
                                                </div>
